...
class ElectionSenatePipeline(EasyPipeline):
    ...
    def steps(params):
        ...
        load_step = LoadStep("election_electoralcollege", connector=params["output-db"], connector_path=__file__, if_exists="append", pk=['year', 'geoid'], engine="ReplacingMergeTree")
